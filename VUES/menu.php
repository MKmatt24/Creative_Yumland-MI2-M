...
<head>
    ...
    let currentMenus = [];
    let container, searchInput, sortSelect, catButtons;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        container = document.getElementById('plats-container');
        searchInput = document.getElementById('ajax-search');
        sortSelect = document.getElementById('sort-select');
        catButtons = document.querySelectorAll('#cat-filters .cat-btn');
